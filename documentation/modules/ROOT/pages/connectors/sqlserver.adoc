...
spec:
  ...
  config:
    ...
    database.dbnames: "testDB,testDB2", // <7>
...
|[[sqlserver-property-database-dbname]]<<sqlserver-property-database-dbname, `+database.dbnames+`>>
|
|The names of the SQL Server databases from which to stream the changes
